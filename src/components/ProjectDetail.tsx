...
import { ArrowLeft, ExternalLink, Github, Calendar, Users, Code, Database, Smartphone, ChevronLeft, ChevronRight,
Target, Zap, Award, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-4 mb-6">
                                <div
                                    className="flex items-center gap-2 text-slate-600 bg-slate-100 px-4 py-2 rounded-lg">
                                    <Calendar size={16} />
                        ...
                        <div className="relative">
                            ...
                            <div
                                className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium text-slate-700">
                                Projet principal
                            </div>
                        </div>
                    </div>
            ...
            <div className="mb-12">
                <div className="bg-white rounded-xl p-8 shadow-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div key={index}
                            className="flex items-start gap-3 p-4 bg-emerald-50 rounded-lg border-l-4 border-emerald-500">
            ...
            <div className="mb-12">
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
                    <div className="relative w-full h-96 overflow-hidden rounded-lg shadow-md group">
                        <div className="w-full h-full overflow-auto">
                            <img src={project.screenshots[currentImageIndex]} alt={`Screenshot ${currentImageIndex +
                                1}`}
                        ...
                        <>
                            <button onClick={prevImage}
                                className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-slate-700 p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
                                aria-label="Image précédente">
                                <ChevronLeft size={24} />
                            </button>
                            <button onClick={nextImage}
                                className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-slate-700 p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
                        ...
                        <div
                            className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium text-white">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    ...
                    <div key={index} className={`cursor-pointer rounded-lg overflow-hidden transition-all duration-200
                        ${ index===currentImageIndex ? 'ring-4 ring-blue-500 shadow-lg scale-105'
                        : 'hover:shadow-md hover:scale-105 opacity-70 hover:opacity-100' }`} onClick={()=>
                        setCurrentImageIndex(index)}
                        >
                        <img src={screenshot} alt={`Miniature ${index + 1}`} className="w-full h-20 object-cover" />
                    </div>
                    ))}
                </div>
                )}
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li key={index}
                                className="flex items-start gap-3 p-4 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors duration-200">
                                <CheckCircle className="text-emerald-600 mt-1 flex-shrink-0" size={20} />
                ...
                <div className="space-y-8">
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li key={index}
                                className="flex items-start gap-3 p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors duration-200">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li key={index}
                                className="flex items-start gap-3 p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors duration-200">
            ...
            <div
                className="bg-gradient-to-r from-blue-600 to-emerald-600 rounded-xl p-8 text-center text-white shadow-xl">
                <h3 className="text-3xl font-bold mb-4">Intéressé par ce projet ?</h3>
                <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
                    Découvrez d'autres réalisations similaires ou contactez-moi pour discuter de vos besoins en
                    développement web
                </p>
